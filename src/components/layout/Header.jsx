  ...
  return (
    <header className={headerClass}>
      <div className="header__inner container">
        <Link to="/" className="header__logo" aria-label="Kristalia — ir al inicio">
          <img src={logo} alt="Kristalia logo" width="44" height="44" />
          <span className="header__logo-name">Kristalia</span>
        </Link>

        <nav className="header__nav" aria-label="Navegación principal">
          <Link to="/" className={`header__nav-link ${isHome && !scrolled ? 'header__nav-link--light' : ''}`}>
            Inicio
          </Link>
          <Link
            to="/quienes-somos"
      ...
      {menuOpen && (
        <div className="header__mobile-menu" role="dialog" aria-label="Menú de navegación">
          <nav>
            <Link to="/" className="header__mobile-link">Inicio</Link>
            <Link to="/quienes-somos" className="header__mobile-link">Quiénes somos</Link>
            <a href="#servicios" className="header__mobile-link" onClick={(e) => handleHashLink(e, '#servicios')}>Servicios</a>
            <a href="#contacto" className="header__mobile-link" onClick={(e) => handleHashLink(e, '#contacto')}>Contacto</a>
          </nav>
